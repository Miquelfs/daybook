...
export function PhotoOfDay({ date, initialPhotoUrl }: Props) {
  ...
  if (!isToday) {
    return (
      <div className="border border-dashed border-[#1C1C1F] rounded-xl px-4 py-6 flex items-center justify-center">
        <p className="text-xs text-[#3F3F46]">No photo this day</p>
      </div>
    );
  }
